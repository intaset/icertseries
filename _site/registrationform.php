<?php
$my_email = "registration@icertseries.com";
$errors = array();
...
Thank you for registering for ICERT 2018. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@icertseries.com. You can find the copyright form here: www.icertseries.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@icertseries.com mentioning the correct information. Please note that you SHOULD NOT refill the form.
...
$your_subject = "Your Registration Details for ICERT'18";

$your_headers = "From: ICERT'18 <" . $my_email . ">";
...
<title>ICERT'18 - Registration Form Filled!</title>
  ...
  <div class="cbp-af-inner">
    <div class="unit unit-s-3-4 unit-m-1-3 unit-l-1-3">
      ...
      <div class="unit unit-s-1-3 unit-m-2-3 unit-m-2-3-1 unit-l-2-3">
        ...
        <div class="bg">
          <h1>2<sup>nd</sup> International Conference on Energy<br>Research and Technology (ICERT'18)</h1>
...
<br><p class="body" style="text-align:center!important;">ICERT'18 is part of the <b>3<sup>rd</sup> World Congress on New Technologies (NewTech'17)</b>. For more information about the congress, please visit the website here: <a href="http://2018.newtechcongress.com/" class="body-link">www.2018.newtechcongress.com</a>.</p>
        </div>
    </div>
...
<div id="main-slider" class="liquid-slider">
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICERT 2018:</p>
      <p class="body">ICERT 2018 will  be held in Madrid, Spain on August 19 - 21, 2018.</p>

      <!--p class="body">As per popular request, the organizing committee has decided to extend the NewTech'17 congress to three days (now August 19 - 21, 2018). The new high-level schedule is as follows:</p>
    ...
    <div>
      ...
      <p class="body">ICERT attracts a wide range of researchers in the field of energy research and technology. As a prominent company in the field of energy research and technology, we would like to offer you an exhibit at ICERT. Please visit <a href="../sponsor" class="body-link">Sponsors</a> for more information.</p>
    </div>
</div>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">If you have requested any official invitation letters, please allow up to 5 business days to receive your documents.</p> 
    ...
    <p class="body">If there are any problems in the information you have filled out, please write an email to us at <a href="mailto:registration@icertseries.com" class="body-link">registration@icertseries.com</a> mentioning the mistakes made. Please note that you SHOULD NOT refill the form.</p>

  <p class="body">We are looking forward to seeing you at ICERT'18!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding ICERT'18, please fill out the form below:</p>
  ...
  <center class="full right cf"><div class="g-recaptcha" data-sitekey="6LeiFyMTAAAAADNCB1_kaUp9fMiNpAzV8VU1fKyN"></div></center>
  <div class="cf">
