...
Thank you for registering for ICERT 2019. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your final version (.doc or .docx format) and a signed copyright form via email to info@icertseries.com. You can find the copyright form here: https://icertseries.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
...
We are pleased to announce that the ICERT 2019 be held at the Hotel Real Palácio. Additionally, we have collaborated with the hotel to offer our attendees a reduced 
rate on their accommodations! This discounted rate is only valid until May 12, 2019. Please view the booking form here: https://icertseries.com/RealPalacioLisbonBookingForm.pdf
...
$your_subject = "Your Registration Details for ICERT'19";

$your_headers = "From: ICERT'19 <" . $my_email . ">";
...
<title>ICERT'19 - Registration Form Filled!</title>
  ...
  <div class="cbp-af-inner">
    <div class="unit unit-s-3-4 unit-m-1-3 unit-l-1-3">
      ...
      <div class="unit unit-s-1-3 unit-m-2-3 unit-m-2-3-1 unit-l-2-3">
        ...
        <div class="bg">
          <h1>3<sup>rd</sup> International Conference on Energy<br>Research and Technology (ICERT'19)</h1>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">We are looking forward to seeing you at ICERT'19!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding ICERT'19, please fill out the form below:</p>
